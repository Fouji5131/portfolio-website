...
const Detail = () => {
  return (
    <div className="flex flex-col xl:w-3/4 space-y-10">
      <div className="flex flex-col sm:flex-row xl:flex-row font-boldItalic space-y-1 sm:space-y-0 sm:space-x-20 xl:space-x-3 xl:space-y-0  text-sm sm:text-md xl:text-lg">
      ...
      <div className="">
        <div className="flex flex-col sm:flex-row xl:flex-row font-regular space-y-1 sm:space-y-0 sm:space-x-10 xl:space-y-0 xl:space-x-20 text-xs sm:text-sm xl:text-sm">
          <div className="flex flex-col ">
            <h1 className="font-boldItalic text-lg sm:text-lg xl:text-xl ">
              <span className="text-3xl sm:text-4xl xl:text-5xl font-bold gradient from-purpleGrad via-redGrad to-yellowGrad">
                10+{" "}
              </span>
              Years experience
            </h1>
      ...
      <div className="flex flex-row p-4 bg-darkGray">
        <img className="object-contain" src={Quotes} alt="" />
        <h1 className="font-italic text-sm sm:text-sm xl:text-lg text-white">
