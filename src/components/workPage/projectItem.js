  ...
  return (
    <div className=" xl:space-y-0 xl:m-10  grid grid-cols-1 xl:grid-cols-2 gap-10 2xl:gap-20 space-y-0 ">
      {props.projectsData.map((projects) => (
        <div className="flex flex-col xl:flex-row space-y-5 xl:space-y-0 rounded-3xl shadow-2xl p-10">
          ...
          <div className="flex justify-center object-contain xl:w-1/2 hover:scale-110">
            <img
